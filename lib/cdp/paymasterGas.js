...
function resolveChainRpcUrl(chainId) {
  ...
  const chainAliases = {
    8453: ["BASE_RPC_ENDPOINT", "BASE_RPC_URL", "BASE_MAINNET_RPC_URL"],
    42161: ["ARBITRUM_RPC_ENDPOINT", "ARBITRUM_RPC_URL", "ARBITRUM_MAINNET_RPC_URL"],
  };

  for (const alias of chainAliases[chainId] || []) {
