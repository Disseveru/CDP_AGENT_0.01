...
test("resolvePersistedDsaId ignores dsaId after Avocado authority switch", () => {
  const signer = "0xAbC000000000000000000000000000000000001";
  const state = {
    signerAddress: signer,
    chains: {
  ...
  assert.equal(
    resolvePersistedDsaId(state, 8453, signer, "0xSafeA00000000000000000000000000000000001"),
    42,
  );
  assert.equal(
    resolvePersistedDsaId(state, 8453, signer, "0xSafeB00000000000000000000000000000000002"),
    undefined,
  );
});

test("resolvePersistedDsaId ignores dsaId when Avocado authority metadata is missing", () => {
  const signer = "0xAbC000000000000000000000000000000000001";
  const safe = "0xSafeB00000000000000000000000000000000002";
  const state = {
    signerAddress: signer,
    chains: {
      "8453": {
  ...
  assert.equal(resolvePersistedDsaId(state, 8453, signer, safe), undefined);
  assert.equal(resolvePersistedDsaId(state, 8453, signer, signer), 42);
});
