...
export const CONFIG = {
  ...
  prices: {
    ...
    screenAsset: process.env.PRICE_SCREEN_ASSET || "$0.004",
    settlementEconomics: process.env.PRICE_SETTLEMENT_ECONOMICS || "$0.005",
    probeFacilitators: process.env.PRICE_PROBE_FACILITATORS || "$0.006",
  },
  captcha: {
