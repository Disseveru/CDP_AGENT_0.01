...
export const CONFIG = {
  ...
  prices: {
    ...
    screenPayAsset: process.env.PRICE_SCREEN_PAY_ASSET || "$0.003",
    allocateAgentBudget: process.env.PRICE_ALLOCATE_AGENT_BUDGET || "$0.004",
    issueDeliveryReceipt: process.env.PRICE_ISSUE_DELIVERY_RECEIPT || "$0.002",
  },
  captcha: {
