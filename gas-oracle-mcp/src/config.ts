...
export const CONFIG = {
  ...
  prices: {
    ...
    rankX402: process.env.PRICE_RANK_X402 || "$0.012",
    normalizeReceipt: process.env.PRICE_NORMALIZE_RECEIPT || "$0.002",
    commercePreflight: process.env.PRICE_COMMERCE_PREFLIGHT || "$0.008",
  },
  captcha: {
