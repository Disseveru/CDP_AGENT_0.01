...
export const CONFIG = {
  ...
  prices: {
    ...
    screenSettlementAsset: process.env.PRICE_SCREEN_SETTLEMENT_ASSET || "$0.004",
    normalizeX402Amount: process.env.PRICE_NORMALIZE_X402_AMOUNT || "$0.002",
    settlementReadiness: process.env.PRICE_SETTLEMENT_READINESS || "$0.008",
  },
  captcha: {
