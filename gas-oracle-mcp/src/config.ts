...
export const CONFIG = {
  ...
  prices: {
    ...
    screenTokenAllowlist: process.env.PRICE_SCREEN_TOKEN_ALLOWLIST || "$0.004",
    pickFacilitatorFailover: process.env.PRICE_PICK_FACILITATOR_FAILOVER || "$0.004",
    issueDeliveryReceipt: process.env.PRICE_ISSUE_DELIVERY_RECEIPT || "$0.005",
    a2aCommerceBundle: process.env.PRICE_A2A_COMMERCE_BUNDLE || "$0.015",
  },
  captcha: {
